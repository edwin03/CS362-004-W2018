...
int main() {
    int newCards = 4;//requires to add 4 cards to the hand deck
    //int newActions = 2;
    //int discarded = 1;
    //int xtraCoins = 0;
    //int xtraBuys = 1;
    //int shuffledCards = 0;
    int playedCards = 1;
    int newCardsinOtherPlayerHand = 1;
	...
	for (i = 0; i < numPlayers; i++){
    	...
    	shouldReturn = i == 1 ? G.deckCount [1-i] - newCards - newCardsinOtherPlayerHand : G.deckCount[1-i] - newCards;
    	realReturn = testG.deckCount[1];
    	if (shouldReturn == realReturn) {
    	...
    	shouldReturn = G.handCount[1-i] + newCardsinOtherPlayerHand;
    	realReturn = testG.handCount[1-i];
    	if (shouldReturn == realReturn) {
			printf("PASSED: Opponent hand count.");
    	} 
    	else {
			printf("FAILED: Opponent hand count expected %d, got %d", shouldReturn, realReturn);
    	}
    	printf("\n");
    	...
    	//shouldReturn = G.numActions + numActions;
    	//realReturn = testG.numActions;
    	//if (shouldReturn == realReturn) {
			//printf("PASSED: Play actions count. ");
    	//} 
    	//else {
			//printf("FAILED: Player action count expected %d, got %d", shouldReturn, realReturn);
    	//}
    	//printf("\n");
